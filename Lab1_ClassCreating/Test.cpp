...
//    /*
//    cout << "Checking input and output operators override\n\n";
//    cout << "Checking Array\n\n";
//    Array arr;
//    std::cin >> arr;
//    cout << arr << "\n";
...
//
//    cout << "\n--------------------------------------\n";
//    cout << "Checking input and output operators override for text and binary files\n\n";
//    cout << "Checking Array\n\n";
//    
//
//    std::ofstream outArr("D:\\Proga\\repos\\OOP_Lab2_OverrideOperators\\OOP_Lab2_OverrideOperators\\array.txt", std::ios::out);
//    
//    Array arrayTxtFile1;
//    Array arrayBinaryFile;
//
//    Array arrayTxtFile;
//    arrayTxtFile.add(3);
//    arrayTxtFile.add(838);
//    arrayTxtFile.add(6827);
//
//    if (outArr.is_open()) {
//        outArr << arrayTxtFile.getArraySize() << " " << arrayTxtFile.getIndex() << "\t" << arrayTxtFile << "\n";
//    }
//
//    outArr.close();
//
//    std::ifstream inArr("D:\\Proga\\repos\\OOP_Lab2_OverrideOperators\\OOP_Lab2_OverrideOperators\\array.txt");
//
//    if (inArr.is_open()) {
//        inArr >> arrayTxtFile1;
//    }
...
//    inArr.close();
//    
//    std::ofstream outArrBin("D:\\Proga\\repos\\OOP_Lab2_OverrideOperators\\OOP_Lab2_OverrideOperators\\arrayBin.txt", std::ios::out | std::ios::binary);
//    
//    arrayTxtFile.add(3645);
//    
//    if (outArrBin.is_open()) {
//        outArrBin << arrayBinaryFile;
//    }
//    outArrBin.close();
//
//    std::ifstream inArrBin("D:\\Proga\\repos\\OOP_Lab2_OverrideOperators\\OOP_Lab2_OverrideOperators\\arrayBin.txt", std::ios::binary);
//    inArrBin >> arrayBinaryFile;
//    inArrBin.close();
//    cout << arrayBinaryFile << "\n";
//    
//    /*
//    cout << "--------------------------------------\nCheking Queue\n\n";
//    std::ofstream outQue("D:\\Proga\\repos\\OOP_Lab2_OverrideOperators\\OOP_Lab2_OverrideOperators\\queue.txt", std::ios::out);
//
//    Queue queueTxtFile1;
//    Queue queueBinaryFile;
//
//    Queue queueTxtFile;
//    queueTxtFile.add(677);
//    queueTxtFile.add(235);
//    queueTxtFile.add(8402);
//
//    if (outQue.is_open()) {
//        outQue << queueTxtFile << "\n";
//    }
...
//    outQue.close();
//
//    std::ifstream inQue("D:\\Proga\\repos\\OOP_Lab2_OverrideOperators\\OOP_Lab2_OverrideOperators\\queue.txt");
//
//    if (inQue.is_open()) {
//        inQue >> queueTxtFile1;
//    }
...
//    inQue.close();
//
//    std::ofstream outQueBin("D:\\Proga\\repos\\OOP_Lab2_OverrideOperators\\OOP_Lab2_OverrideOperators\\queueBin.txt", std::ios::binary);
//
//    queueTxtFile.add(7689);
//
//    if (outQueBin.is_open()) {
//        outQueBin << queueTxtFile;
//    }
//    outQueBin.close();
//
//    std::ifstream inQueBin("D:\\Proga\\repos\\OOP_Lab2_OverrideOperators\\OOP_Lab2_OverrideOperators\\queueBin.txt", std::ios::binary);
//    inQueBin >> queueBinaryFile;
//    inQueBin.close();
//    cout << queueBinaryFile << "\n";
//    */
//}
//
...
TEST_CASE("Write file")
{
    ...
    arr1.toTxtFile("D:\\Proga\\repos\\OOP_Lab2_OverrideOperators\\OOP_Lab2_OverrideOperators\\array.txt");
}
